...
METHOD 2:
Copy the code from index.html as is and follow the outlook steps.
delete the example sections if not used. 
create a new row where a new item should go and copy paste which ever is relevant:
